...
const tsProjectConfigs = ["./tsconfig.json", "./tsconfig.node.json"];
...
const javascriptReactRules = Object.assign(standardRules, {
  // JAVASCRIPT REACT - new rules here or overrides
});

const typescriptReactRules = Object.assign(standardRules, {
  // TYPESCRIPT REACT - new rules here or overrides
...
const javascriptReact = defineConfig({
  overrides: [
    {
      env,
      excludedFiles,
...
const typescriptReact = defineConfig({
  overrides: [
    {
      env,
      excludedFiles,
